...
> 
> `r tufte::quote_footer('--- Alan Perlis')`
...
```{r echo=F, out.width=300, fig.align='left'}
  knitr::include_graphics('img/lockfile.png')
```
...
```{r echo=F, out.width=300, fig.align='center'}
  knitr::include_graphics('https://media.giphy.com/media/zcCGBRQshGdt6/giphy.gif')
```
